    ...
    public void UpdateCustomer()
    {
        ...
        for(Customer i:customers){
            if(i.getId()==idd){
                ...
                System.out.println("Insert the new data for the client");
                Customer newClient=new Customer();
                newClient=newClient.readClient();
                customerDB.update(newClient,i);
            }
        }
        customers=  customerDB.read();
    }
        ...
        if(card.getSecurityCode()==pin)
        {
            ...
            if(input==1 || input==2)
            {
                if(input==1)
                {
                    ...
                    Transaction tranz=new Transaction(amou,"Deposit");
                ...
                else
                {
                    ...
                    System.out.println("");
                    double amou=cin.nextDouble();
                    Transaction tranz=new Transaction(amou,"Withdrawl");

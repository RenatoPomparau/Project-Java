...
import Model.Cards.Credit;
import Model.Cards.Debit;
...
public class CardDB {
    ...
    public void create(Card card, Customer client, Account cont) throws SQLException {
        try{
            ...
            preparedStmt.setInt(2,client.getId());
            preparedStmt.setInt(3, (cont.getAccountNumber()));
            preparedStmt.setString(4, client.getName());
            Date expp=card.getExpirationDate();
            SimpleDateFormat outputFormat = new SimpleDateFormat("yyyy-MM-dd");
            String data = outputFormat.format(expp);

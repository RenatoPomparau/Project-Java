...
public class Savings extends Card {
    ...
    public void depositMoney(double amount) {
        ...
        Transaction tranzactie=new Transaction(this.getId_tranzactie(),amount,"Deposit");
        increment_ID_transactie();
        this.transactions.add(tranzactie);
    }
    public void addInterestRate() {
        balance += balance*(interestRate/100);
        transactions.add(new Transaction(this.getId_tranzactie(),balance*(interestRate/100),"Interest Rate Deposit"));
        increment_ID_transactie();
    }
    ...
    public void withdrawlMoney(double amount) {
        if (balance < amount+amount*(PercentForWithdrawl/100) ){
           ...
           // Transaction tranzacite=new Transaction(increment(this.getId_tranzactie()),amount,"Deposit");
            transactions.add(new Transaction((this.getId_tranzactie()),amount,"Withdrawl"));
            increment_ID_transactie();
            transactions.add(new Transaction((this.getId_tranzactie()), amount*(PercentForWithdrawl/100),"Withdrawl tax penalty"));
            increment_ID_transactie();
        }
    }
